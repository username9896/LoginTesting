...
// const waterIntake = [200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000, 2200, 2400, 2600, 2800, 3000, 3200, 3400, 3600, 3800, 4000];

// for (let i = 0; i < waterIntake.length - 15; i++) {
//   const currentValue = waterIntake[i];
//   const nextFifteenthValue = waterIntake[i + 15];

//   if (Math.abs(currentValue - nextFifteenthValue) >= 200) {
//     console.log("You have drank the water!");
//   }
// }
